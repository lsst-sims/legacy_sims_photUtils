...
class Variability(PhotometryBase):
    ...
    def calculate_stellar_variability(self, u0=None, g0=None, r0=None, i0=None, z0=None, y0=None,
        ...
        for vv in varParams:
            if vv != numpy.unicode_("None"):
                deltaMag, deltaMagNorm = self.applyVariability(vv, expmjd)
    ...
    def get_galaxy_variability(self):
        ...
        for vv in varParams:
            if vv != numpy.unicode_("None"):
                deltaMag, deltaMagNorm=self.applyVariability(vv, self.obs_metadata.mjd)
    ...
    def applyVariability(self, varParams, expmjd):
        """
