# -*- coding: utf-8 -*-
#
# Phot Utils documentation build configuration file, created by
...
from lsst.sims.photUtils import __version__
version = __version__
...
latex_documents = [
  (master_doc, 'PhotUtils.tex', u'Phot Utils Documentation',
...
man_pages = [
    (master_doc, 'photutils', u'Phot Utils Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'PhotUtils', u'Phot Utils Documentation',
   author, 'PhotUtils', 'One line description of project.',
   'Miscellaneous'),
]
